# Wortgraph Coach — submission video script (~3:10)
...
article and example sentence on the card. Optionally end on the Der/Die/Das
game tile in Arena.)*
...
## SHOT 4 — Arena: Odd-One-Out + "How the graph built this round" (35s)
...
Cypher that built the round. There's even a der-die-das game for drilling
articles. The reasoning is never a black box.
